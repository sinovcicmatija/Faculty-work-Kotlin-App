...
class RecommendedBooksAdapter : ListAdapter<Book, RecommendedBooksAdapter.RecommendedBookViewHolder>(DiffCallback) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecommendedBookViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_book, parent, false)
        return RecommendedBookViewHolder(view)
    }

    override fun onBindViewHolder(holder: RecommendedBookViewHolder, position: Int) {
    ...
    inner class RecommendedBookViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
